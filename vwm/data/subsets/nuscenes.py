...
class NuScenesDataset(BaseDataset):
    def __init__(self, data_root="/share/data/drive_4/jean/amine/Vista/data/nuScenes", anno_file="/share/data/drive_4/jean/amine/Vista/data/nuScenes/annos/nuScenes.json",
